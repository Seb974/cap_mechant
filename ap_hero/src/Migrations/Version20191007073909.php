 ...
 */
final class Version20191007073909 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE metadata DROP city_id, CHANGE phone_number phone_number INT DEFAULT NULL, CHANGE field field VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE cart CHANGE user_id user_id INT DEFAULT NULL, CHANGE total_tax total_tax DOUBLE PRECISION DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE cart_item CHANGE cart_id cart_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE metadata ADD city_id INT NOT NULL, CHANGE phone_number phone_number INT DEFAULT NULL, CHANGE field field VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci');
