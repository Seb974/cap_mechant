 ...
 */
final class Version20191008091439 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE `order` ADD tax_rate DOUBLE PRECISION NOT NULL, ADD internal_id VARCHAR(64) NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE `order` DROP tax_rate, DROP internal_id');
    }
}
