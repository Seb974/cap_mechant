 ...
 */
final class Version20191007072433 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE metadata DROP facturation_address, DROP delivery_address, CHANGE phone_number phone_number INT DEFAULT NULL, CHANGE field field VARCHAR(255) DEFAULT NULL');
