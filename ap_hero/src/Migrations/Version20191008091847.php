 ...
 */
final class Version20191008091847 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE `order` CHANGE order_status order_status VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE `order` CHANGE order_status order_status VARCHAR(60) NOT NULL COLLATE utf8mb4_unicode_ci');
    }
}
